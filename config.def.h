...
static const char *fonts[]          = { "JetBrainsMonoNLNerdFontMono:style=Regular:size=14", "monospace:size=14", "status:style=Regular" };
...
static const char col_blue1[]       = "#565bf2";
static const char col_scarlet[]     = "#cc0000";
...
static const char *colors[][3]      = {
    ...
    [SchemeSel]  = { col_gray4, col_cyan,  col_blue1 },
    [SchemeStatus]  = { col_green, col_black,  col_black  }, // Statusbar right {text,background,not used but cannot be empty}
...
static const char *homecal[] = { "chromium", "--app=https://calendar.google.com", NULL };
static const char *workcal[] = { "chromium", "--app=https://outlook.office365.com/calendar/view/week", NULL };
static const char *slackcmd[] = { "chromium", "--app=https://app.slack.com/client/T7CAAK9NJ/C7BHR0GMB", NULL };
static const char *spotifycmd[] = { "chromium", "--app=https://open.spotify.com", NULL };
static const char *whatsappcmd[] = { "chromium", "--app=https://web.whatsapp.com", NULL };
static const char *volcmd[] = { "pavucontrol", NULL };
static const char *volupcmd[] = { "pactl", "set-sink-volume", "0", "+5%", NULL };
static const char *voldowncmd[] = { "pactl", "set-sink-volume", "0", "-5%", NULL };
static const char *volmuttogglecmd[] = { "pactl", "set-sink-mute", "0", "toggle", NULL };
