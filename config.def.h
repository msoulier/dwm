...
static const char *teamscmd[] = { "brave-browser", "--app=https://teams.microsoft.com/v2/", NULL };
...
static Key keys[] = {
    ...
    { ALTKEY|ControlMask,           XK_e,      spawn,          {.v = tfilemgr } },
    { ALTKEY|ControlMask|ShiftMask, XK_e,      spawn,          {.v = gfilemgr } },
    ...
    { ALTKEY|ControlMask,           XK_f,      spawn,          {.v = feedlycmd } },
    { ALTKEY|ControlMask|ShiftMask, XK_t,      spawn,          {.v = teamscmd } },
