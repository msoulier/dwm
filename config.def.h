...
static const char *fonts[]          = { "Terminus:style=Regular:size=10", "monospace:size=10", "status:style=Regular" };
...
static const char *worktermcmd[]  = { "/usr/bin/x-terminal-emulator", "-e", "cappuccino", NULL };
